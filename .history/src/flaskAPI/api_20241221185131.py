...
global IFSTART
IFSTART = False
global IFNODESTART111
IFNODESTART111 = False
...
def serv():
    ...
    # 开启服务
    if isopen == '1' and not IFSTART and not IFNODESTART:
        IFSTART = True
        IFNODESTART = True
    ...
    # 关闭服务
    elif isopen == '0' and IFSTART and IFNODESTART:
        IFSTART = False
        IFNODESTART = False
    ...
    #服务关闭 并且已经关闭
    elif isopen == '0' and not IFSTART and not IFNODESTART:
        return jsonify({
    ...
    #服务开启 多次调用
    elif isopen == '1' and IFSTART and IFNODESTART:
        return jsonify({
